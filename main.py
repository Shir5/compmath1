...
from linear_system_simple_Iteration import simple_iteration_method
from simpleiteration import iterative_method
...
def main():
    ...
    if var == "4":
        ...
        result, f = simple_iteration_method(system, jacobian, [x, y], acc)
    ...
    func_2_name = "3x^3 + 1,7x^2 - 15,42x + 6,89"
    func_3_name = "exp(x^2)"
    ...
    func_2 = lambda x: 3 * x ** 3 + 1.7 * x ** 2 - 15.42 * x + 6.89
    ...
    if var == "1":
        ...
        result = newton_method(func, a, b, acc)
